...
with st.sidebar:
    ...
    - [Linkedin](https://www.linkedin.com/in/rahul-purigilla-816666225/)
    
    ''')
    st.write("Created By Rahul Purigilla")
...
def main():
    ...
    if api_key:
        ...
        conn_str = "DRIVER={ODBC Driver 17 for SQL Server};Server=LAPTOP-CG86NI1D;Database=AdventureWorks2022;trusted_connection=yes;"
